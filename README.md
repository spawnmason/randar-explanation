...
**If you want to use the Randar exploit yourself**, go [here](https://hobune.stream/randar/) where [rebane2001](https://twitter.com/rebane2001) has created a website where you can drag in your ReplayMod files from 1.12.2 and see the coordinates of other players. It runs client-side so your recordings will not leave your browser. [Here's a video](https://www.youtube.com/watch?v=YnNCvJU43kY) of what that website looks like in action, and you can run the example ReplayMod file from that video by [downloading it here](https://github.com/spawnmason/randar-explanation/raw/master/media/replaymod_randar_example_2023_07_08_22_34_30.mcpr). Currently it will only work for recordings taken on 2b2t, but we will add the ability to customize the world seed soon.
